        ...
        "episodes": [
            {
                ...
                "synopsis": "The reading of the matriarch's will shocks Sandton elite as an unknown daughter walks in.",
                "duration_seconds": 78,
            ...
            },
            {
                ...
                "synopsis": "A midnight confrontation in the Khumalo mansion exposes a 20-year pact.",
                "duration_seconds": 82,
                ...
                "coin_price": 0,
                "cliffhanger_time": 72,
                "cliffhanger_hook": "The safe was already emptied before midnight.",
                "likes_count": 118000,
                "views_count": 980000,
                "comments_count": 3210,
            ...
            },
            {
                ...
                "synopsis": "An ally in the boardroom turns into the deadliest rival.",
                "duration_seconds": 86,
                ...
                "coin_price": 0,
                "cliffhanger_time": 76,
                "cliffhanger_hook": "Drink it, or sign the shares over now.",
                "likes_count": 96000,
                "views_count": 820000,
                "comments_count": 2890,
            ...
            },
            {
                ...
                "episode_number": 4,
                "title": "Bloodline War",
                "synopsis": "The true royal elder convenes an emergency tribal council in KwaZulu-Natal.",
                "duration_seconds": 90,
                ...
                "coin_price": 5,
                "cliffhanger_time": 80,
                "cliffhanger_hook": "The chief holds the original birth certificate.",
                "likes_count": 84000,
                "views_count": 690000,
                "comments_count": 2450,
    ...
    },
    {
        ...
        "episodes": [
            ...
            },
            {
                ...
                "synopsis": "Moving into the penthouse brings unexpected intimacy and lurking enemies.",
                "duration_seconds": 59,
                "video_url": "/videos/flower_bloom.mp4",
                "thumbnail_url": "/posters/ceo_secret_wife.jpg",
                "is_free": True,
                "coin_price": 0,
                "cliffhanger_time": 51,
                "cliffhanger_hook": "His ex-fiancée arrives with an unexpected key.",
                "likes_count": 139000,
                "views_count": 1120000,
                "comments_count": 3890,
            ...
            },
            {
                ...
                "synopsis": "Trapped in an elevator during a storm, the facade falls away completely.",
                "duration_seconds": 63,
                "video_url": "/videos/sample_drama.mp4",
                "thumbnail_url": "/posters/ceo_secret_wife.jpg",
                "is_free": False,
                "coin_price": 5,
                "cliffhanger_time": 55,
                "cliffhanger_hook": "This wasn't part of the contract.",
                "likes_count": 128000,
                "views_count": 980000,
                "comments_count": 3410,
...
def seed_database_if_empty(force: bool = False):
    existing_stories = db.get("stories")
    if len(existing_stories) > 0 and not force:
        return

    print("[SEED] Seeding Welele™ with vibrant African micro-dramas (Blood Ties, The CEO's Secret Wife, Zulu Love Story, The Hustlers)...")
    db.set("creators", DEFAULT_CREATORS)
    db.set("stories", DEFAULT_STORIES)
    db.set("users", DEFAULT_USERS)
    print(f"[SEED] Successfully seeded {len(DEFAULT_STORIES)} African microdrama series and {len(DEFAULT_CREATORS)} creators!")
